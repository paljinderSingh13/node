			...
			return (
				'<div class="timepicker-picker">' +
					'<table class="table-condensed">' +
						'<tr>' +
							'<td><button type="button" class="btn btn-time" data-action="incrementHours"><i class="fa fa-angle-up"></i></button></td>' +
							'<td class="separator"></td>' +
							'<td>' + (picker.options.useMinutes ? '<button type="button" class="btn btn-time" data-action="incrementMinutes"><i class="fa fa-angle-up"></i></button>' : '') + '</td>' +
							(picker.options.useSeconds ?
								'<td class="separator"></td><td><button type="button" class="btn btn-time" data-action="incrementSeconds"><i class="fa fa-angle-up"></i></button></td>' : '') +
						...
						'<tr>' +
							...
							(picker.options.use24hours ? '' : '<td class="separator"></td>' +
							'<td><button type="button" class="btn btn-timepicker" data-action="togglePeriod"></button></td>') +
						'</tr>' +
						'<tr>' +
							'<td><button type="button" class="btn btn-time" data-action="decrementHours"><i class="fa fa-angle-down"></i></a></td>' +
							'<td class="separator"></td>' +
							'<td>' + (picker.options.useMinutes ? '<button type="button" class="btn btn-time" data-action="decrementMinutes"><i class="fa fa-angle-down"></i></button>' : '') + '</td>' +
							(picker.options.useSeconds ?
								'<td class="separator"></td><td><button type="button" class="btn btn-time" data-action="decrementSeconds"><i class="fa fa-angle-down"></i></button></td>' : '') +
							(picker.options.use24hours ? '' : '<td class="separator"></td>') +
						'</tr>' +
					'</table>' +
				'</div>' +
